...
public class StructureData
{
    ...
    private List<Structure> structureList = Arrays.asList(new Structure[] {
        ...
        new Structure(R.drawable.ic_tree1, "Tree"),
        new Structure(R.drawable.ic_tree2, "Tree"),
        new Structure(R.drawable.ic_tree3, "Tree"),
        new Structure(R.drawable.ic_tree4, "Tree"),
    });
